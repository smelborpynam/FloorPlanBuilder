...
(function (FP) {
  ...
  var BODY = [
    ...
    '<p>Hold <kbd>Shift</kbd> while dragging an outside wall to do the opposite: stretch or squash the <b>whole plan</b> proportionally, every room at once. <b>Re-balance room sizes</b> does something similar, resetting every room to its ideal proportions.</p>',
    ...
    '<tr><td><kbd>Shift</kbd>+drag outside wall</td><td>Scale the whole plan instead of just that edge</td></tr>',
